...
def customize_scripts(filename)
  ...
  if filename == "bash_profile"
    if hostname == "imac.local"
      ...
      ENV["PATH"] = "/Users/jsmith/Python/CPython-2.7.8/bin:/Users/jsmith/Python/CPython-3.4.1/bin:/Users/jsmith/Python/PyPy-2.2.1/bin:/opt/twitter/bin:$PATH:/usr/local/bin:${HOME}/bin:/opt/twitter/sbin:${HOME}/.twitools/src/twitter-utilities/sbt:$PATH"
